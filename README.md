...
<body>
    <table>
        <tr>
            <td>(1) Generate the Video (.mp4) from the pre-collected environment frames (.PNG format) (Specific resolution, frame rate) <a href="(1-1-2) Content">How to generate</a>
 </td>
        </tr>
        <tr>
